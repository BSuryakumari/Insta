        ...
        <div>
          ...
          <div className="profile-page-container-lg">
            <div className="profile-page-info-container">
              <div>
                <img
                  className="profile-page-info-image "
                  src={profilePic}
                  alt={`${owner} profile`}
                />
              </div>
              <div className="name-user-info-container">
                <h1 className="profile-page-main-heading">{userName}</h1>
                <ul className="profile-unordered-list-container">
                  <li className="profile-page-list-items">
                    <h1 className="profile-page-heading">{postsCount}</h1>
                    <p className="profile-page-paragraph">posts</p>
                  </li>
                  <li className="profile-page-list-items marg">
                    <h1 className="profile-page-heading">{followersCount}</h1>
                    <p className="profile-page-paragraph ">followers</p>
                  </li>
                  <li className="profile-page-list-items">
                    <h1 className="profile-page-heading">{followingCount}</h1>
                    <p className="profile-page-paragraph">following</p>
                  </li>
                </ul>
